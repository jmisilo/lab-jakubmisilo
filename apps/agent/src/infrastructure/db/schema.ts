...
export const agentNotedMemories = pgTable(
  ...
  (table) => [
    index('agent_noted_memories_identity_importance_idx').on(table.identityId, table.importance),
    index('agent_noted_memories_identity_updated_at_idx').on(table.identityId, table.updatedAt),
