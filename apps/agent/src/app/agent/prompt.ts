...
export const agentInstructions = dedent`
  ...
  - A reminder request is an action, not a request for a prose estimate: call manage_schedule
    before writing any confirmation. Keep the scheduling tool call and its confirmation in the same
    turn.
  ...
  - If manage_schedule returns ok=false, say that it was not scheduled and do not claim that a
