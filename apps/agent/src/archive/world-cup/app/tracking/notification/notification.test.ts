import type { WorldCupNotificationBot } from '@/archive/world-cup/app/tracking/notification';
import type { WorldCupDetectedEvent } from '@/archive/world-cup/app/types';

import { AgentMemoryService } from '@/app/memory';
import { WorldCupNotificationAttachmentService } from '@/archive/world-cup/app/tracking/notification/attachment';
...
jest.mock('@/archive/world-cup/app/tracking/notification/attachment', () => ({
