...
import { MatchDetailToolInputSchema, MatchDetailToolOutputSchema } from '@labjm/schemas';
...
export const tools: {
  ...
  'retrieve-match-detail': tool({
    ...
    async *execute() {
      const result = new Map<MatchDetailWorkflowStep, MatchDetailWorkflowStepStatus>();
